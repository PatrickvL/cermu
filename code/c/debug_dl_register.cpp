...
int main() {
    ...
    std::cout << "=== DEBUGGING DL REGISTER FOR ASL $40 ===" << std::endl;
    ...
    std::cout << "DL register: $" << std::hex << std::setfill('0') << std::setw(2) << (int)cpu.get_reg(CpuReg::DL) << std::endl;
    std::cout << std::endl;
    
    // Execute cycles and monitor DL register
    ...
    do {
        ...
        std::cout << "Data on bus: $" << std::hex << std::setfill('0') << std::setw(2) << (int)data << std::endl;
        std::cout << "DL register BEFORE cycle_tick(): $" << std::hex << std::setfill('0') << std::setw(2) << (int)cpu.get_reg(CpuReg::DL) << std::endl;
        ...
        std::cout << "DL register AFTER cycle_tick(): $" << std::hex << std::setfill('0') << std::setw(2) << (int)cpu.get_reg(CpuReg::DL) << std::endl;
