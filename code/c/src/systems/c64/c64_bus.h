...
// Debug functions to dump bank layout for all PLA modes
void c64_bus_debug_dump_bank_layout(struct c64_s* c64);
void c64_bus_debug_dump_vicii_bank_layout(struct c64_s* c64);
