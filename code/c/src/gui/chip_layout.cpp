/*
 * chip_laoyt.cpp - Generic chip layout implementation
...
PinLayout create_mos6502_layout() {
    ...
    layout.markings = {
        "MOS 6502",                  // part_number
        "MOS Technology",            // manufacturer
        nullptr,                     // package_variant
        nullptr,                     // date_code
        nullptr,                     // lot_number
        "8-bit CPU",                 // custom_text
    ...
    // 6502 CPU pinout
    layout.left_pins = {
        make_power_pin(1, "VSS"),
        make_control_pin(2, "RDY", false),
        make_clock_pin(3, "φ1"),
        make_interrupt_pin(4, "IRQ", true),
        make_nc_pin(5),
        make_interrupt_pin(6, "NMI", true),
        make_control_pin(7, "SYNC", false),
        make_power_pin(8, "VCC"),
        make_address_pin(9, "A0", 0),
        make_address_pin(10, "A1", 1),
        make_address_pin(11, "A2", 2),
        make_address_pin(12, "A3", 3),
        make_address_pin(13, "A4", 4),
        make_address_pin(14, "A5", 5),
        make_address_pin(15, "A6", 6),
        make_address_pin(16, "A7", 7),
        make_address_pin(17, "A8", 8),
        make_address_pin(18, "A9", 9),
        make_address_pin(19, "A10", 10),
        make_address_pin(20, "A11", 11)
    };
    
    layout.right_pins = {
        make_power_pin(21, "VSS"),
        make_address_pin(22, "A12", 12),
        make_address_pin(23, "A13", 13),
        make_address_pin(24, "A14", 14),
        make_address_pin(25, "A15", 15),
        make_data_pin(26, "D7", 7),
        make_data_pin(27, "D6", 6),
        make_data_pin(28, "D5", 5),
        make_data_pin(29, "D4", 4),
        make_data_pin(30, "D3", 3),
        make_data_pin(31, "D2", 2),
        make_data_pin(32, "D1", 1),
        make_data_pin(33, "D0", 0),
        make_control_pin(34, "R/W", false),
        make_nc_pin(35),
        make_control_pin(36, "BE", false),
        make_clock_pin(37, "φ0"),
        make_control_pin(38, "SO", true),
        make_clock_pin(39, "φ2"),
        make_interrupt_pin(40, "RES", true)
    };
