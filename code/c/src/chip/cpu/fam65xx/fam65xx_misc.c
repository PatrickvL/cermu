...
void fam65xx_cmp_immediate(fam65xx_t* cpu) {
    fam65xx_arithmetic_helper(cpu, fam65xx_addr_imm, fam65xx_op_cmp);
}

void fam65xx_cmp_zero_page(fam65xx_t* cpu) {
    fam65xx_arithmetic_helper(cpu, fam65xx_addr_zp, fam65xx_op_cmp);
}

void fam65xx_cmp_zero_page_x(fam65xx_t* cpu) {
    fam65xx_arithmetic_helper(cpu, fam65xx_addr_zpx, fam65xx_op_cmp);
}

void fam65xx_cmp_absolute(fam65xx_t* cpu) {
    fam65xx_arithmetic_helper(cpu, fam65xx_addr_abs, fam65xx_op_cmp);
}

void fam65xx_cmp_absolute_x(fam65xx_t* cpu) {
    fam65xx_arithmetic_helper(cpu, fam65xx_addr_absx, fam65xx_op_cmp);
}

void fam65xx_cmp_absolute_y(fam65xx_t* cpu) {
    fam65xx_arithmetic_helper(cpu, fam65xx_addr_absy, fam65xx_op_cmp);
}

void fam65xx_cmp_indirect_x(fam65xx_t* cpu) {
    fam65xx_arithmetic_helper(cpu, fam65xx_addr_indx, fam65xx_op_cmp);
}

void fam65xx_cmp_indirect_y(fam65xx_t* cpu) {
    fam65xx_arithmetic_helper(cpu, fam65xx_addr_indy, fam65xx_op_cmp);
}

// CPX - Compare X Register
void fam65xx_cpx_immediate(fam65xx_t* cpu) {
    fam65xx_arithmetic_helper(cpu, fam65xx_addr_imm, fam65xx_op_cpx);
}

void fam65xx_cpx_zero_page(fam65xx_t* cpu) {
    fam65xx_arithmetic_helper(cpu, fam65xx_addr_zp, fam65xx_op_cpx);
}

void fam65xx_cpx_absolute(fam65xx_t* cpu) {
    fam65xx_arithmetic_helper(cpu, fam65xx_addr_abs, fam65xx_op_cpx);
}

// CPY - Compare Y Register
void fam65xx_cpy_immediate(fam65xx_t* cpu) {
    fam65xx_arithmetic_helper(cpu, fam65xx_addr_imm, fam65xx_op_cpy);
}

void fam65xx_cpy_zero_page(fam65xx_t* cpu) {
    fam65xx_arithmetic_helper(cpu, fam65xx_addr_zp, fam65xx_op_cpy);
}

void fam65xx_cpy_absolute(fam65xx_t* cpu) {
    fam65xx_arithmetic_helper(cpu, fam65xx_addr_abs, fam65xx_op_cpy);
}
...
// BIT - Bit Test
void fam65xx_bit_zero_page(fam65xx_t* cpu) {
    fam65xx_arithmetic_helper(cpu, fam65xx_addr_zp, fam65xx_op_bit);
}

void fam65xx_bit_absolute(fam65xx_t* cpu) {
    fam65xx_arithmetic_helper(cpu, fam65xx_addr_abs, fam65xx_op_bit);
}
