...
static const opcode_info_t fam65xx_opcode_table[256] = {
    ...
    OP(AM_REL,0,OP_BCC,0), OP(AM_INY,0,OP_STA,0), OP(AM_NON,0,OP_JAM,0), OP_ILLEGAL_STORE(AM_INY,1,OP_SHA,0), OP(AM_ZPX,0,OP_STY,0), OP(AM_ZPX,0,OP_STA,0), OP(AM_ZPY,0,OP_STX,0), OP(AM_ZPY,0,OP_SAX,0),
    OP(AM_NON,0,OP_TYA,0), OP(AM_ABY,0,OP_STA,0), OP(AM_NON,0,OP_TXS,0), OP_ILLEGAL_STORE(AM_ABY,1,OP_SHS,0), OP_ILLEGAL_STORE(AM_ABX,1,OP_SHY,0), OP(AM_ABX,0,OP_STA,0), OP_ILLEGAL_STORE(AM_ABY,1,OP_SHX,0), OP_ILLEGAL_STORE(AM_ABY,1,OP_SHA,0),
