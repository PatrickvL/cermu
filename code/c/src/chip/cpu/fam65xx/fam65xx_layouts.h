...
ChipLayout create_mos6502_layout() {
    ...
    PIN_LR(15, A6,    35, NC)
    PIN_LR(16, A7,    36, NC)
    PIN_LR(17, A8,    37, PHI0)
    PIN_LR(18, A9,    38, SO)
    PIN_LR(19, A10,   39, PHI2)
    PIN_LR(20, A11,   40, RES)
...
ChipLayout create_mos6510_layout() {
    ...
    PIN_LR(1,  PHI0,  21, VSS)
    PIN_LR(2,  RDY,   22, A12)
    PIN_LR(3,  IRQ,   23, A13)
    PIN_LR(4,  NMI,   24, P0)    // I/O Port bit 0
    PIN_LR(5,  AEC,   25, P1)    // I/O Port bit 1
    PIN_LR(6,  VDD,   26, P2)    // I/O Port bit 2
    PIN_LR(7,  A0,    27, P3)    // I/O Port bit 3
    PIN_LR(8,  A1,    28, P4)    // I/O Port bit 4
    PIN_LR(9,  A2,    29, P5)    // I/O Port bit 5
    PIN_LR(10, A3,    30, D7)
    PIN_LR(11, A4,    31, D6)
    PIN_LR(12, A5,    32, D5)
    PIN_LR(13, A6,    33, D4)
    ...
    PIN_LR(17, A10,   37, D0)
    PIN_LR(18, A11,   38, RW)
    PIN_LR(19, A14,   39, PHI2)
    PIN_LR(20, A15,   40, RES)
...
ChipLayout create_wdc_w65c02s_layout() {
    ...
    PIN_LR(1,  VP,    21, VSS)   // Vector Pull
    PIN_LR(2,  RDY,   22, A12)   // Bidirectional on 65C02
    PIN_LR(3,  PHI1,  23, A13)
    PIN_LR(4,  IRQ,   24, A14)
    PIN_LR(5,  ML,    25, A15)   // Memory Lock
    PIN_LR(6,  NMI,   26, D7)
    PIN_LR(7,  SYNC,  27, D6)
    PIN_LR(8,  VDD,   28, D5)
    PIN_LR(9,  A0,    29, D4)
    ...
    PIN_LR(14, A5,    34, RW)
    PIN_LR(15, A6,    35, NC)
    PIN_LR(16, A7,    36, BE)    // Bus Enable on 65C02
    PIN_LR(17, A8,    37, PHI0)
    PIN_LR(18, A9,    38, SO)
    PIN_LR(19, A10,   39, PHI2)
    PIN_LR(20, A11,   40, RES)
...
ChipLayout create_wdc_65c816_layout() {
    ...
    PIN_LR(1,  VPB,   21, VSS)   // Vector Pull Bar
    PIN_LR(2,  RDY,   22, A12)
    PIN_LR(3,  ABORT, 23, A13)   // Abort
    PIN_LR(4,  IRQ,   24, A14)
    PIN_LR(5,  ML,    25, A15)   // Memory Lock
    PIN_LR(6,  NMI,   26, D7)
    PIN_LR(7,  VPA,   27, D6)    // Valid Program Address
    PIN_LR(8,  VDD,   28, D5)
    PIN_LR(9,  A0,    29, D4)
    PIN_LR(10, A1,    30, D3)
    PIN_LR(11, A2,    31, D2)
    ...
    PIN_LR(13, A4,    33, D0)
    PIN_LR(14, A5,    34, RW)
    PIN_LR(15, A6,    35, E)      // Emulation mode
    PIN_LR(16, A7,    36, BE)     // Bus Enable
    PIN_LR(17, A8,    37, PHI0)
    PIN_LR(18, A9,    38, MX)     // M/X Status
    PIN_LR(19, A10,   39, VDA)    // Valid Data Address
    PIN_LR(20, A11,   40, RES)
...
ChipLayout create_ricoh_2a03_layout() {
    ...
    PIN_LR(1,  VSS,   21, VSS)
    PIN_LR(2,  RDY,   22, A12)   // Tied high internally in some revisions
    PIN_LR(3,  PHI1,  23, A13)
    PIN_LR(4,  IRQ,   24, A14)
    PIN_LR(5,  NC,    25, A15)
    PIN_LR(6,  NMI,   26, D7)
    ...
    PIN_LR(14, A5,    34, RW)
    PIN_LR(15, A6,    35, NC)
    PIN_LR(16, A7,    36, NC)    // No BE on 2A03
    PIN_LR(17, A8,    37, PHI0)
    PIN_LR(18, A9,    38, SO)
    PIN_LR(19, A10,   39, PHI2)
    PIN_LR(20, A11,   40, RES)
...
ChipLayout create_rockwell_r65c02_layout() {
    ...
    PIN_LR(14, A5,    34, RW)
    PIN_LR(15, A6,    35, NC)
    PIN_LR(16, A7,    36, BE)    // Bus Enable on R65C02
    PIN_LR(17, A8,    37, PHI0)
    PIN_LR(18, A9,    38, SO)
    PIN_LR(19, A10,   39, PHI2)
    PIN_LR(20, A11,   40, RES)
