...
union {
    uint8_t reg8[Traits.has(CPUCoreFlags::C816_16BIT) ? REG_COUNT_16BIT : REG_COUNT_8BIT];
    uint16_t reg16[(Traits.has(CPUCoreFlags::C816_16BIT) ? REG_COUNT_16BIT : REG_COUNT_8BIT) / 2];
};
