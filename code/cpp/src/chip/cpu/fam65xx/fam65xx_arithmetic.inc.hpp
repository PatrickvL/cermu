 ...
 *
 * This file contains the perform_* helper methods that implement hardware-accurate
 * arithmetic operations including BCD (Binary Coded Decimal) support for the
 * MOS 65xx family of processors.
 *
