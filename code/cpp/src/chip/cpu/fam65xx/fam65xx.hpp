...
// ============================================================================
// REGISTER LAYOUT MIXINS (moved from fam65xx_register_mixins.hpp)
// ============================================================================

/*
 * Register Layout Mixins for MOS 65xx Family
 *
 * This section contains two different register layout mixins:
...
#include "operations/wide.inc.hpp"             // 65C816 16-bit operations
    ...
    void init_opcode_table() {
        ...
        addressing_mode_handlers[to_index(AM::SR)] = &fam65xx_t::am_sr;       // Stack Relative
