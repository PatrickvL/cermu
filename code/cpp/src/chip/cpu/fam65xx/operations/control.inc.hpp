...
bus_state_t op_jsr(bus_state_t pins) {
    switch (this->cycle_index) {
        case 0:
            ...
            pins = this->phi2_read(pins, static_cast<reg16_t>(REG_PC), static_cast<reg8_t>(REG_ABL));
        ...
        case 2:
            ...
            if (this->should_complete_write_cycle(pins)) {
                pins = this->phi2_write(pins, static_cast<reg16_t>(REG_SP), this->get(REG_PCH));
                this->dec(REG_S);
                this->cycle_index++;
            }
            return pins;
        ...
        case 3:
            ...
            if (this->should_complete_write_cycle(pins)) {
                pins = this->phi2_write(pins, static_cast<reg16_t>(REG_SP), this->get(REG_PCL));
                this->dec(REG_S);
                this->cycle_index++;
            }
            return pins;
        ...
        case 4:
            ...
            pins = this->phi2_read(pins, static_cast<reg16_t>(REG_PC), static_cast<reg8_t>(REG_ABH));
            if (FAM65XX_GET_RDY(pins)) {
...
bus_state_t op_rts(bus_state_t pins) {
    switch (this->cycle_index) {
        ...
        case 2:
            ...
            pins = this->phi2_read(pins, static_cast<reg16_t>(REG_SP), static_cast<reg8_t>(REG_PCL));
            if (FAM65XX_GET_RDY(pins)) {
                this->inc(REG_S);
                this->cycle_index++;
            }
        ...
        case 3:
            ...
            pins = this->phi2_read(pins, static_cast<reg16_t>(REG_SP), static_cast<reg8_t>(REG_PCH));
            if (FAM65XX_GET_RDY(pins)) {
                this->cycle_index++;
            }
            return pins;
...
bus_state_t op_brk(bus_state_t pins) {
    switch (this->cycle_index) {
        ...
        case 3:
            ...
            if (this->should_complete_write_cycle(pins)) {
                pins = this->phi2_write(pins, static_cast<reg16_t>(REG_SP), this->get(REG_DL));
                this->dec(REG_S);
        ...
        case 4:
            ...
            pins = this->phi2_read(pins, static_cast<reg16_t>(REG_AB), static_cast<reg8_t>(REG_PCL));
            if (FAM65XX_GET_RDY(pins)) {
                this->cycle_index++;
                this->inc(REG_AB);
            }
        ...
        case 5:
            ...
            pins = this->phi2_read(pins, static_cast<reg16_t>(REG_AB), static_cast<reg8_t>(REG_PCH));
            if (FAM65XX_GET_RDY(pins)) {
