        ...
        switch (this->cycle_index) {
            ...
            case 2:
                ...
                /* TODO_WRITE: Remove check */ if (this->should_complete_write_cycle(pins)) {
                    pins = this->/*TODO_WRITE*/phi2_write<Addr::SP>(pins, this->get(REG_ABH));
                    this->dec(REG_S);
                    this->cycle_index++;
                }
                return pins;
            ...
            case 3:
                // Push low byte
                /* TODO_WRITE: Remove check */ if (this->should_complete_write_cycle(pins)) {
                    pins = this->/*TODO_WRITE*/phi2_write<Addr::SP>(pins, this->get(REG_ABL)); // addr_low from case 0
                    this->dec(REG_S);
                    this->transition_to_fetch();
                }
                return pins;
...
bus_state_t op_phb(bus_state_t pins) {
    ...
    if constexpr (this->has_wide_registers()) {
        // Push DBR to stack
        /* TODO_WRITE: Remove check */ if (this->should_complete_write_cycle(pins)) {
            pins = this->/*TODO_WRITE*/phi2_write<Addr::SP>(pins, this->get(REG_DBR));
            this->dec(REG_S);
            this->transition_to_fetch();
        }
        return pins;
    ...
    if constexpr (this->has_wide_registers()) {
        switch (this->cycle_index) {
            case 0:
                ...
                /* TODO_WRITE: Remove check */ if (this->should_complete_write_cycle(pins)) {
                    pins = this->/*TODO_WRITE*/phi2_write<Addr::SP>(pins, this->get(REG_DPH));
                    this->dec(REG_S);
                    this->cycle_index++;
                }
                return pins;
            ...
            case 1:
                // Push D low byte
                /* TODO_WRITE: Remove check */ if (this->should_complete_write_cycle(pins)) {
                    pins = this->/*TODO_WRITE*/phi2_write<Addr::SP>(pins, this->get(REG_DPL));
                    this->dec(REG_S);
                    this->transition_to_fetch();
                }
                return pins;
    ...
    if constexpr (this->has_wide_registers()) {
        switch (this->cycle_index) {
            ...
            case 1:
                // Push PBR to stack
                /* TODO_WRITE: Remove check */ if (this->should_complete_write_cycle(pins)) {
                    pins = this->/*TODO_WRITE*/phi2_write<Addr::SP>(pins, this->get(REG_PBR));
                    this->dec(REG_S);
                    this->transition_to_fetch();
                }
                return pins;
    ...
    if constexpr (this->has_wide_registers()) {
        switch (this->cycle_index) {
            ...
            case 4:
                ...
                /* TODO_WRITE: Remove check */ if (this->should_complete_write_cycle(pins)) {
                    pins = this->/*TODO_WRITE*/phi2_write<Addr::SP>(pins, this->get(REG_PCH));
                    this->dec(REG_S);
                    this->cycle_index++;
                }
                return pins;
            ...
            case 5:
                // Push PC low byte
                /* TODO_WRITE: Remove check */ if (this->should_complete_write_cycle(pins)) {
                    pins = this->/*TODO_WRITE*/phi2_write<Addr::SP>(pins, this->get(REG_PCL));
                    this->dec(REG_S);
    ...
    if constexpr (this->has_wide_registers()) {
        ...
        switch (this->cycle_index) {
            ...
            case 3:
                ...
                /* TODO_WRITE: Remove check */ if (this->should_complete_write_cycle(pins)) {
                    pins = this->/*TODO_WRITE*/phi2_write<Addr::SP>(pins, this->get(REG_ABL));
                    this->dec(REG_S);
                    this->transition_to_fetch();
                }
                return pins;
    ...
    if constexpr (this->has_wide_registers()) {
        switch (this->cycle_index) {
            ...
            case 4:
                ...
                /* TODO_WRITE: Remove check */ if (this->should_complete_write_cycle(pins)) {
                    pins = this->/*TODO_WRITE*/phi2_write<Addr::SP>(pins, this->get(REG_P));
                    this->dec(REG_S);
