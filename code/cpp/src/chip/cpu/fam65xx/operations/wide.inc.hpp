...
bus_state_t op_pea(bus_state_t pins) {
  ...
  if constexpr (this->has_wide_registers()) {
    ...
    case 2:
      ...
      pins =
          this->/*TODO_WRITE*/ phi2_write<Addr::SP>(pins, this->get(REG_ABH));
      this->dec(REG_S);
      this->cycle_index++;
      return pins;
    ...
    case 3:
      ...
      pins = this->/*TODO_WRITE*/ phi2_write<Addr::SP>(
...
bus_state_t op_phb(bus_state_t pins) {
  ...
  if constexpr (this->has_wide_registers()) {
    ...
    pins =
        this->/*TODO_WRITE*/ phi2_write<Addr::SP>(pins, this->get(REG_DBR));
    this->dec(REG_S);
    this->transition_to_fetch();
    return pins;
  }
...
bus_state_t op_phd(bus_state_t pins) {
  ...
  if constexpr (this->has_wide_registers()) {
    ...
    case 0:
      ...
      pins =
          this->/*TODO_WRITE*/ phi2_write<Addr::SP>(pins, this->get(REG_DPH));
      this->dec(REG_S);
      this->cycle_index++;
      return pins;
    ...
    case 1:
      ...
      pins =
          this->/*TODO_WRITE*/ phi2_write<Addr::SP>(pins, this->get(REG_DPL));
      this->dec(REG_S);
      this->transition_to_fetch();
      return pins;
    }
...
bus_state_t op_phk(bus_state_t pins) {
  ...
  if constexpr (this->has_wide_registers()) {
    ...
    case 1:
      ...
      pins =
          this->/*TODO_WRITE*/ phi2_write<Addr::SP>(pins, this->get(REG_PBR));
      this->dec(REG_S);
      this->transition_to_fetch();
      return pins;
    }
...
bus_state_t op_jsl(bus_state_t pins) {
  ...
  if constexpr (this->has_wide_registers()) {
    ...
    case 4:
      ...
      pins =
          this->/*TODO_WRITE*/ phi2_write<Addr::SP>(pins, this->get(REG_PCH));
      this->dec(REG_S);
      this->cycle_index++;
      return pins;
    ...
    case 5:
      ...
      pins =
          this->/*TODO_WRITE*/ phi2_write<Addr::SP>(pins, this->get(REG_PCL));
      this->dec(REG_S);
...
bus_state_t op_per(bus_state_t pins) {
  ...
  if constexpr (this->has_wide_registers()) {
    ...
    case 3:
      ...
      pins =
          this->/*TODO_WRITE*/ phi2_write<Addr::SP>(pins, this->get(REG_ABL));
      this->dec(REG_S);
      this->transition_to_fetch();
      return pins;
    }
...
bus_state_t op_cop(bus_state_t pins) {
  ...
  if constexpr (this->has_wide_registers()) {
    ...
    case 4:
      ...
      pins =
          this->/*TODO_WRITE*/ phi2_write<Addr::SP>(pins, this->get(REG_P));
      this->dec(REG_S);
