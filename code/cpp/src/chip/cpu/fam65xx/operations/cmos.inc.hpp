...
bus_state_t op_bra(bus_state_t pins) {
  ...
  bus_state_t op_stp(bus_state_t pins) {
    ...
    // PHX - Push X Register (65C02) - Hardware-accurate 3-cycle operation like
    // PHA
    ...
    // PHY - Push Y Register (65C02) - Hardware-accurate 3-cycle operation like
    // PHA
    ...
    // PLX - Pull X Register (65C02) - Hardware-accurate 4-cycle operation like
    // PLA
    bus_state_t op_plx(bus_state_t pins) {
      ...
      if constexpr (has_cmos()) {
        ...
        case 2:
          /* PHI2: Read from incremented stack pointer directly into X
           * (eliminates copy) */
    ...
    // PLY - Pull Y Register (65C02) - Hardware-accurate 4-cycle operation like
    // PLA
    bus_state_t op_ply(bus_state_t pins) {
      ...
      if constexpr (has_cmos()) {
        ...
        case 2:
          /* PHI2: Read from incremented stack pointer directly into Y
           * (eliminates copy) */
          pins = this->bus_setup_read<Addr::SP>(pins);
