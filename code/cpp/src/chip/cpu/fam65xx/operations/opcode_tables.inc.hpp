...
constexpr std::array<opcode_info_t, 256> generate_opcode_table_for_traits(const fam65xx::CPUTraits& traits) {
    ...
    table[0x03] = {OP::SLO, AM::INX, OF::RMW};   // SLO - Shift Left then OR (illegal)
    table[0x04] = {OP::NOP, AM::ZER, OF::NONE};  // NOP zp - illegal NOP
    table[0x05] = {OP::ORA, AM::ZER, OF::NONE};
    table[0x06] = {OP::ASL, AM::ZER, OF::RMW};
    table[0x07] = {OP::SLO, AM::ZER, OF::RMW};   // SLO - Shift Left then OR (illegal)
    ...
    table[0x0F] = {OP::SLO, AM::ABS, OF::RMW};   // SLO - Shift Left then OR (illegal)
    ...
    table[0x13] = {OP::SLO, AM::INY, OF::RMW};   // SLO - Shift Left then OR (illegal)
    table[0x14] = {OP::NOP, AM::ZPX, OF::NONE};  // NOP zp,X - illegal NOP
    table[0x15] = {OP::ORA, AM::ZPX, OF::NONE};
    table[0x16] = {OP::ASL, AM::ZPX, OF::RMW};
    table[0x17] = {OP::SLO, AM::ZPX, OF::RMW};   // SLO - Shift Left then OR (illegal)
    ...
    table[0x1B] = {OP::SLO, AM::ABY, OF::RMW};   // SLO - Shift Left then OR (illegal)
    ...
    table[0x2F] = {OP::RLA, AM::ABS, OF::RMW};   // RLA - Rotate Left then AND (illegal)
    ...
    table[0x33] = {OP::RLA, AM::INY, OF::RMW};   // RLA - Rotate Left then AND (illegal)
    table[0x34] = {OP::NOP, AM::ZPX, OF::NONE};  // NOP zp,X - illegal NOP
    table[0x35] = {OP::AND, AM::ZPX, OF::NONE};
    table[0x36] = {OP::ROL, AM::ZPX, OF::RMW};
    table[0x37] = {OP::RLA, AM::ZPX, OF::RMW};   // RLA - Rotate Left then AND (illegal)
    ...
    table[0x5F] = {OP::SRE, AM::ABX, OF::RMW};   // SRE - Shift Right then EOR (illegal)
    table[0x60] = {OP::RTS, AM::NON, OF::NONE};
    table[0x61] = {OP::ADC, AM::INX, OF::NONE};
    table[0x62] = {OP::JAM, AM::NON, OF::NONE};  // KIL/JAM - illegal opcode
    table[0x63] = {OP::RRA, AM::INX, OF::RMW};   // RRA - Rotate Right then ADC (illegal)
    table[0x64] = {OP::NOP, AM::ZER, OF::NONE};  // NOP zp - illegal NOP (2-byte) - will be overridden for 65C02
    table[0x65] = {OP::ADC, AM::ZER, OF::NONE};
    table[0x66] = {OP::ROR, AM::ZER, OF::RMW};
    table[0x67] = {OP::RRA, AM::ZER, OF::RMW};   // RRA - Rotate Right then ADC (illegal)
    ...
    table[0x6F] = {OP::RRA, AM::ABS, OF::RMW};   // RRA - Rotate Right then ADC (illegal)
    ...
    table[0x73] = {OP::RRA, AM::INY, OF::RMW};   // RRA - Rotate Right then ADC (illegal)
    table[0x74] = {OP::NOP, AM::ZPX, OF::NONE};  // NOP zp,X - illegal NOP
    table[0x75] = {OP::ADC, AM::ZPX, OF::NONE};
    table[0x76] = {OP::ROR, AM::ZPX, OF::RMW};
    table[0x77] = {OP::RRA, AM::ZPX, OF::RMW};   // RRA - Rotate Right then ADC (illegal)
    table[0x78] = {OP::SEI, AM::NON, OF::NONE};
    table[0x79] = {OP::ADC, AM::ABY, OF::SKIP_PAGE};
    table[0x7A] = {OP::NOP, AM::NON, OF::NONE};  // NOP - illegal NOP
    table[0x7B] = {OP::RRA, AM::ABY, OF::RMW};   // RRA - Rotate Right then ADC (illegal)
    table[0x7C] = {OP::NOP, AM::ABX, OF::SKIP_PAGE}; // JMP (abs,X) - illegal NOP (3-byte) - will be overridden for 65C02
    table[0x7D] = {OP::ADC, AM::ABX, OF::SKIP_PAGE};
    table[0x7E] = {OP::ROR, AM::ABX, OF::RMW};
    table[0x7F] = {OP::RRA, AM::ABX, OF::RMW};   // RRA - Rotate Right then ADC (illegal)
    ...
    table[0x8B] = {OP::XAA, AM::IMM, OF::NONE};  // XAA - Transfer X AND imm to A (illegal)
    table[0x8C] = {OP::STY, AM::ABS, OF::NONE};
    table[0x8D] = {OP::STA, AM::ABS, OF::NONE};
    table[0x8E] = {OP::STX, AM::ABS, OF::NONE};
    table[0x8F] = {OP::SAX, AM::ABS, OF::NONE};  // SAX - Store A AND X (illegal) - will be overridden for CMOS
    table[0x90] = {OP::BCC, AM::REL, OF::NONE};
    table[0x91] = {OP::STA, AM::INY, OF::NONE};
    table[0x92] = {OP::JAM, AM::NON, OF::NONE};  // KIL/JAM - illegal opcode
    table[0x93] = {OP::SHA, AM::INY, OF::ILLEGAL_STORE};  // SHA - Store A AND X AND (addr_hi+1) (illegal)
    ...
    table[0x9B] = {OP::SHS, AM::ABY, OF::ILLEGAL_STORE};  // SHS - Store (A AND X) AND ((addr_hi)+1) to S (illegal)
    table[0x9C] = {OP::SHY, AM::ABX, OF::ILLEGAL_STORE};  // SHY - Store Y AND ((addr_hi)+1) (illegal) - will be overridden for 65C02
    table[0x9D] = {OP::STA, AM::ABX, OF::NONE};
    table[0x9E] = {OP::SHX, AM::ABY, OF::ILLEGAL_STORE};  // SHX - Store X AND ((addr_hi)+1) (illegal) - will be overridden for CMOS
    table[0x9F] = {OP::SHA, AM::ABY, OF::ILLEGAL_STORE};  // SHA - Store A AND X AND (addr_hi+1) (illegal) - will be overridden for CMOS
    ...
    table[0xB3] = {OP::LAX, AM::INY, OF::SKIP_PAGE}; // LAX - Load A and X (illegal)
    ...
    table[0xEF] = {OP::ISC, AM::ABS, OF::RMW};   // ISC - Increment then SBC (illegal)
    ...
    table[0xFF] = {OP::ISC, AM::ABX, OF::RMW};   // ISC - Increment then SBC (illegal)
    ...
    if (traits.has(fam65xx::CPUCoreFlags::CMOS_BASE) && !traits.has(fam65xx::CPUCoreFlags::WAI_STP) && !traits.has(fam65xx::CPUCoreFlags::ROCKWELL_BITS)) {
        ...
        table[0x1A] = {OP::INC, AM::ACC, OF::NONE};  // INC A - Increment Accumulator (supported on Synertek 65C02)
        table[0x3A] = {OP::DEC, AM::ACC, OF::NONE};  // DEC A - Decrement Accumulator (supported on Synertek 65C02)
        table[0x64] = {OP::NOP, AM::ZER, OF::NONE};  // STZ zp -> 2-byte NOP (zero page) - not supported
        table[0x7C] = {OP::NOP, AM::ABS, OF::NONE};  // JMP (abs,X) -> 3-byte NOP (absolute) - not supported
        table[0x9C] = {OP::NOP, AM::ABS, OF::NONE};  // STZ abs -> 3-byte NOP (absolute) - not supported
    ...
    if (traits.has(fam65xx::CPUCoreFlags::CMOS_BASE)) {
        ...
        // Replace ALL other illegal opcodes with appropriate NOPs for Synertek 65C02 compatibility
        // Based on test failures, many need to be 2-byte NOPs (AM::IMM) to match expected PC advancement
        ...
        table[0x12] = {OP::ORA, AM::ZPI, OF::NONE};  // ORA ($nn) - ORA zero page indirect (65C02)
        ...
        table[0x1F] = {OP::NOP, AM::ABS, OF::NONE};  // SLO -> 3-byte NOP (absolute,X)
        ...
        table[0x2F] = {OP::NOP, AM::ABS, OF::NONE};  // RLA -> NOP (special case: must match ProcessorTests expectations)
        table[0x32] = {OP::AND, AM::ZPI, OF::NONE};  // AND ($nn) - AND zero page indirect (65C02)
        table[0x33] = {OP::NOP, AM::NON, OF::NONE};  // RLA -> NOP
        table[0x34] = {OP::BIT, AM::ZPX, OF::NONE};  // BIT zp,X - BIT zero page,X (65C02)
        table[0x3C] = {OP::BIT, AM::ABX, OF::SKIP_PAGE}; // BIT abs,X - BIT absolute,X (65C02)
        table[0x37] = {OP::NOP, AM::IMM, OF::NONE};  // RLA -> 2-byte NOP
        table[0x3B] = {OP::NOP, AM::NON, OF::NONE};  // RLA -> NOP
        table[0x3F] = {OP::NOP, AM::ABS, OF::NONE};  // RLA -> 3-byte NOP (absolute,X)
        ...
        table[0x52] = {OP::EOR, AM::ZPI, OF::NONE};  // EOR ($nn) - EOR zero page indirect (65C02)
        ...
        table[0x5F] = {OP::NOP, AM::ABS, OF::NONE};  // SRE -> 3-byte NOP (absolute,X)
        ...
        table[0x72] = {OP::ADC, AM::ZPI, OF::NONE};  // ADC ($nn) - Add with Carry zero page indirect (65C02)
        ...
        table[0x7C] = {OP::JMP, AM::ABI, OF::NONE};  // JMP (abs,X) - JMP absolute indexed indirect (ALL 65C02)
        table[0x7F] = {OP::NOP, AM::ABS, OF::NONE};  // RRA -> 3-byte NOP (absolute,X)
        table[0x83] = {OP::NOP, AM::NON, OF::NONE};  // SAX -> NOP
        table[0x87] = {OP::NOP, AM::IMM, OF::NONE};  // SAX -> 2-byte NOP
        table[0x89] = {OP::BIT, AM::IMM, OF::NONE};  // BIT #imm - BIT immediate (ALL 65C02)
        table[0x8B] = {OP::NOP, AM::NON, OF::NONE};  // XAA -> NOP
        table[0x8F] = {OP::NOP, AM::ABS, OF::NONE};  // SAX -> 3-byte NOP (absolute addressing)
        table[0x92] = {OP::STA, AM::ZPI, OF::NONE};  // STA ($nn) - Store A zero page indirect (65C02)
        ...
        table[0x9C] = {OP::NOP, AM::ABS, OF::NONE};  // SHY -> 3-byte NOP (will be overridden for 65C02)
        table[0x9E] = {OP::NOP, AM::ABX, OF::NONE};  // SHX -> 3-byte NOP (absolute,X addressing)
        table[0x9F] = {OP::NOP, AM::ABY, OF::NONE};  // SHA -> 3-byte NOP (absolute,Y addressing)
        ...
        table[0xAF] = {OP::NOP, AM::ABS, OF::NONE};  // LAX -> 3-byte NOP (absolute addressing)
        table[0xB2] = {OP::LDA, AM::ZPI, OF::NONE};  // LDA ($nn) - Load A zero page indirect (65C02)
        ...
        table[0xBF] = {OP::NOP, AM::ABY, OF::NONE};  // LAX -> 3-byte NOP (absolute,Y addressing)
        table[0xC3] = {OP::NOP, AM::NON, OF::NONE};  // DCP -> NOP
        table[0xC7] = {OP::NOP, AM::IMM, OF::NONE};  // DCP -> 2-byte NOP
        table[0xCB] = {OP::NOP, AM::NON, OF::NONE};  // SBX -> NOP (will be overridden for 65C02)
        table[0xCF] = {OP::NOP, AM::ABS, OF::NONE};  // DCP -> 3-byte NOP (absolute addressing)
        table[0xD2] = {OP::CMP, AM::ZPI, OF::NONE};  // CMP ($nn) - Compare A zero page indirect (65C02)
        table[0xD3] = {OP::NOP, AM::NON, OF::NONE};  // DCP -> NOP
        table[0xD7] = {OP::NOP, AM::IMM, OF::NONE};  // DCP -> 2-byte NOP
        table[0xDA] = {OP::NOP, AM::NON, OF::NONE};  // NOP -> NOP (will be overridden for 65C02)
        table[0xDB] = {OP::NOP, AM::ABY, OF::NONE};  // DCP -> 3-byte NOP (absolute,Y addressing) (will be overridden for 65C02)
        table[0xDF] = {OP::NOP, AM::ABX, OF::NONE};  // DCP -> 3-byte NOP (absolute,X addressing)
        ...
        table[0xEF] = {OP::NOP, AM::ABS, OF::NONE};  // ISC -> 3-byte NOP (absolute addressing)
        table[0xF2] = {OP::SBC, AM::ZPI, OF::NONE};  // SBC ($nn) - Subtract with Carry zero page indirect (65C02)
        table[0xF3] = {OP::NOP, AM::NON, OF::NONE};  // ISC -> NOP
        table[0xF7] = {OP::NOP, AM::IMM, OF::NONE};  // ISC -> 2-byte NOP
        table[0xFA] = {OP::NOP, AM::NON, OF::NONE};  // NOP -> NOP (will be overridden for 65C02)
        table[0xFB] = {OP::NOP, AM::NON, OF::NONE};  // ISC -> NOP
        table[0xFF] = {OP::NOP, AM::ABX, OF::NONE};  // ISC -> 3-byte NOP (absolute,X addressing)
        
        // Add 65C02 enhancements - ALL CMOS processors support these accumulator instructions
        table[0x1A] = {OP::INC, AM::ACC, OF::NONE};  // INC A - Increment Accumulator (all 65C02 variants)
        table[0x3A] = {OP::DEC, AM::ACC, OF::NONE};  // DEC A - Decrement Accumulator (all 65C02 variants)
        ...
        if (traits.has(fam65xx::CPUCoreFlags::CMOS_BASE) && !traits.has(fam65xx::CPUCoreFlags::WAI_STP) && !traits.has(fam65xx::CPUCoreFlags::ROCKWELL_BITS)) {
            ...
            table[0xCB] = {OP::NOP, AM::NON, OF::NONE};  // WAI -> 1-byte NOP (implied) - halt immediately on Synertek 65C02
            table[0xDB] = {OP::NOP, AM::IMM, OF::NONE};  // STP -> 2-byte NOP (immediate) - not supported on Synertek 65C02
        }
    }
