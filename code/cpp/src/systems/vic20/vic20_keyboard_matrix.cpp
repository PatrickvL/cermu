...
const uint32_t keyboard_matrix_unshifted_vic20[VIC20_KEYBOARD_ROWS][VIC20_KEYBOARD_COLS] = {
...
const uint32_t keyboard_matrix_shifted_vic20[VIC20_KEYBOARD_ROWS][VIC20_KEYBOARD_COLS] = {
...
const keyboard_matrix_config_t vic20_keyboard_config = {
    ...
    .unshifted = (const uint32_t*)keyboard_matrix_unshifted_vic20,
    .shifted = (const uint32_t*)keyboard_matrix_shifted_vic20,
};
