...
void cia1_handle_read(void) {
    ...
    switch (reg) {
        ...
        default: bus_state.data = 0xFF; break; // Unmapped registers
    }
}
...
void cia2_handle_read(void) {
    uint8_t reg = bus_state.address & 0x0F;
    switch (reg) {
        case 0x00: bus_state.data = cia2.port_a; break;
        case 0x01: bus_state.data = cia2.port_b; break;
        case 0x04: bus_state.data = cia2.timer_a & 0xFF; break;
        case 0x05: bus_state.data = cia2.timer_a >> 8; break;
        case 0x0D: bus_state.data = cia2.interrupt_status; cia2.interrupt_status = 0; break;
        default: bus_state.data = 0xFF; break; // Unmapped registers
    }
}
...
void cia2_handle_write(void) {
    uint8_t reg = bus_state.address & 0x0F;
    switch (reg) {
        case 0x00: cia2.port_a = bus_state.data; break;
        case 0x01: cia2.port_b = bus_state.data; break;
        case 0x04: cia2.timer_a_latch = (cia2.timer_a_latch & 0xFF00) | bus_state.data; break;
        case 0x05: cia2.timer_a_latch = (cia2.timer_a_latch & 0x00FF) | (bus_state.data << 8); break;
        case 0x0E: cia2.control_a = bus_state.data; break;
        case 0x0D: cia2.interrupt_control = bus_state.data; break;
        // Writes to unmapped registers are ignored
    }
}