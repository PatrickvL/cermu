...
void slo_zero_page_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, slo_zp_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, slo_zp_wait2);
...
void slo_indirect_x_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, slo_ind_x_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, slo_ind_x_wait2);
    (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs); // Dummy read
    cpu_dev->addr_abs = (cpu_dev->addr_abs + cpu_dev->x) & 0xFF;
    CPU_READY_OR_STALL(cpu_dev, slo_ind_x_wait3);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->lo = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, slo_ind_x_wait4);
    cpu_data = cpu_read_cycle(cpu_dev, (cpu_dev->addr_abs + 1) & 0xFF);
    cpu_dev->hi = cpu_data;
    cpu_dev->addr_abs = (cpu_dev->hi << 8) | cpu_dev->lo;
    CPU_READY_OR_STALL(cpu_dev, slo_ind_x_wait5);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->temp = cpu_data;
...
void slo_indirect_y_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, slo_ind_y_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, slo_ind_y_wait2);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->lo = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, slo_ind_y_wait3);
    cpu_data = cpu_read_cycle(cpu_dev, (cpu_dev->addr_abs + 1) & 0xFF);
    cpu_dev->hi = cpu_data;
    cpu_dev->addr_abs = (cpu_dev->hi << 8) | cpu_dev->lo;
    if ((cpu_dev->addr_abs & 0xFF00) != ((cpu_dev->addr_abs + cpu_dev->y) & 0xFF00)) {
        CPU_READY_OR_STALL(cpu_dev, slo_ind_y_wait4);
        (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->y); // Page cross
    }
    CPU_READY_OR_STALL(cpu_dev, slo_ind_y_wait5);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->y);
    cpu_dev->temp = cpu_data;
...
void slo_absolute_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, slo_abs_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, slo_abs_wait2);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs |= (cpu_data << 8);
    CPU_READY_OR_STALL(cpu_dev, slo_abs_wait3);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->temp = cpu_data;
...
void slo_absolute_y_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, slo_abs_y_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->lo = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, slo_abs_y_wait2);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->hi = cpu_data;
    cpu_dev->addr_abs = (cpu_dev->hi << 8) | cpu_dev->lo;
    if ((cpu_dev->addr_abs & 0xFF00) != ((cpu_dev->addr_abs + cpu_dev->y) & 0xFF00)) {
        CPU_READY_OR_STALL(cpu_dev, slo_abs_y_wait3);
        (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->y); // Page cross
    }
    CPU_READY_OR_STALL(cpu_dev, slo_abs_y_wait4);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->y);
    cpu_dev->temp = cpu_data;
...
void slo_absolute_x_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, slo_abs_x_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->lo = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, slo_abs_x_wait2);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->hi = cpu_data;
    cpu_dev->addr_abs = (cpu_dev->hi << 8) | cpu_dev->lo;
    if ((cpu_dev->addr_abs & 0xFF00) != ((cpu_dev->addr_abs + cpu_dev->x) & 0xFF00)) {
        CPU_READY_OR_STALL(cpu_dev, slo_abs_x_wait3);
        (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->x); // Page cross
    }
    CPU_READY_OR_STALL(cpu_dev, slo_abs_x_wait4);
...
void slo_zero_page_x_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, slo_zp_x_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, slo_zp_x_wait2);
    (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs); // Dummy read
    cpu_dev->addr_abs = (cpu_dev->addr_abs + cpu_dev->x) & 0xFF;
    CPU_READY_OR_STALL(cpu_dev, slo_zp_x_wait3);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->temp = cpu_data;
...
void rla_zero_page_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, rla_zp_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, rla_zp_wait2);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->temp = cpu_data;
...
void rla_indirect_x_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, rla_ind_x_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, rla_ind_x_wait2);
    (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs); // Dummy read
    cpu_dev->addr_abs = (cpu_dev->addr_abs + cpu_dev->x) & 0xFF;
    CPU_READY_OR_STALL(cpu_dev, rla_ind_x_wait3);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->lo = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, rla_ind_x_wait4);
    cpu_data = cpu_read_cycle(cpu_dev, (cpu_dev->addr_abs + 1) & 0xFF);
    cpu_dev->hi = cpu_data;
    cpu_dev->addr_abs = (cpu_dev->hi << 8) | cpu_dev->lo;
    CPU_READY_OR_STALL(cpu_dev, rla_ind_x_wait5);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->temp = cpu_data;
...
void rla_indirect_y_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, rla_ind_y_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, rla_ind_y_wait2);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->lo = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, rla_ind_y_wait3);
    cpu_data = cpu_read_cycle(cpu_dev, (cpu_dev->addr_abs + 1) & 0xFF);
    cpu_dev->hi = cpu_data;
    cpu_dev->addr_abs = (cpu_dev->hi << 8) | cpu_dev->lo;
    if ((cpu_dev->addr_abs & 0xFF00) != ((cpu_dev->addr_abs + cpu_dev->y) & 0xFF00)) {
        CPU_READY_OR_STALL(cpu_dev, rla_ind_y_wait4);
        (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->y); // Page cross
    }
    CPU_READY_OR_STALL(cpu_dev, rla_ind_y_wait5);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->y);
    cpu_dev->temp = cpu_data;
...
void rla_absolute_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, rla_abs_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, rla_abs_wait2);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs |= (cpu_data << 8);
    CPU_READY_OR_STALL(cpu_dev, rla_abs_wait3);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->temp = cpu_data;
...
void rla_absolute_y_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, rla_abs_y_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->lo = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, rla_abs_y_wait2);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->hi = cpu_data;
    cpu_dev->addr_abs = (cpu_dev->hi << 8) | cpu_dev->lo;
    if ((cpu_dev->addr_abs & 0xFF00) != ((cpu_dev->addr_abs + cpu_dev->y) & 0xFF00)) {
        CPU_READY_OR_STALL(cpu_dev, rla_abs_y_wait3);
        (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->y); // Page cross
    }
    CPU_READY_OR_STALL(cpu_dev, rla_abs_y_wait4);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->y);
    cpu_dev->temp = cpu_data;
...
void rla_absolute_x_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, rla_abs_x_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->lo = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, rla_abs_x_wait2);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->hi = cpu_data;
    cpu_dev->addr_abs = (cpu_dev->hi << 8) | cpu_dev->lo;
    if ((cpu_dev->addr_abs & 0xFF00) != ((cpu_dev->addr_abs + cpu_dev->x) & 0xFF00)) {
        CPU_READY_OR_STALL(cpu_dev, rla_abs_x_wait3);
        (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->x); // Page cross
    }
    CPU_READY_OR_STALL(cpu_dev, rla_abs_x_wait4);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->x);
    cpu_dev->temp = cpu_data;
...
void rla_zero_page_x_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, rla_zp_x_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, rla_zp_x_wait2);
    (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs); // Dummy read
    cpu_dev->addr_abs = (cpu_dev->addr_abs + cpu_dev->x) & 0xFF;
    CPU_READY_OR_STALL(cpu_dev, rla_zp_x_wait3);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->temp = cpu_data;
...
void sre_zero_page_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, sre_zp_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, sre_zp_wait2);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->temp = cpu_data;
...
void sre_indirect_x_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, sre_ind_x_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, sre_ind_x_wait2);
    (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs); // Dummy read
    cpu_dev->addr_abs = (cpu_dev->addr_abs + cpu_dev->x) & 0xFF;
    CPU_READY_OR_STALL(cpu_dev, sre_ind_x_wait3);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->lo = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, sre_ind_x_wait4);
    cpu_data = cpu_read_cycle(cpu_dev, (cpu_dev->addr_abs + 1) & 0xFF);
    cpu_dev->hi = cpu_data;
    cpu_dev->addr_abs = (cpu_dev->hi << 8) | cpu_dev->lo;
    CPU_READY_OR_STALL(cpu_dev, sre_ind_x_wait5);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->temp = cpu_data;
...
void sre_indirect_y_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, sre_ind_y_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, sre_ind_y_wait2);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->lo = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, sre_ind_y_wait3);
    cpu_data = cpu_read_cycle(cpu_dev, (cpu_dev->addr_abs + 1) & 0xFF);
    cpu_dev->hi = cpu_data;
    cpu_dev->addr_abs = (cpu_dev->hi << 8) | cpu_dev->lo;
    if ((cpu_dev->addr_abs & 0xFF00) != ((cpu_dev->addr_abs + cpu_dev->y) & 0xFF00)) {
        CPU_READY_OR_STALL(cpu_dev, sre_ind_y_wait4);
        (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->y); // Page cross
    }
    CPU_READY_OR_STALL(cpu_dev, sre_ind_y_wait5);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->y);
    cpu_dev->temp = cpu_data;
...
void sre_absolute_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, sre_abs_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, sre_abs_wait2);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs |= (cpu_data << 8);
    CPU_READY_OR_STALL(cpu_dev, sre_abs_wait3);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->temp = cpu_data;
...
void sre_absolute_y_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, sre_abs_y_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->lo = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, sre_abs_y_wait2);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->hi = cpu_data;
    cpu_dev->addr_abs = (cpu_dev->hi << 8) | cpu_dev->lo;
    if ((cpu_dev->addr_abs & 0xFF00) != ((cpu_dev->addr_abs + cpu_dev->y) & 0xFF00)) {
        CPU_READY_OR_STALL(cpu_dev, sre_abs_y_wait3);
        (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->y); // Page cross
    }
    CPU_READY_OR_STALL(cpu_dev, sre_abs_y_wait4);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->y);
    cpu_dev->temp = cpu_data;
...
void sre_absolute_x_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, sre_abs_x_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->lo = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, sre_abs_x_wait2);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->hi = cpu_data;
    cpu_dev->addr_abs = (cpu_dev->hi << 8) | cpu_dev->lo;
    if ((cpu_dev->addr_abs & 0xFF00) != ((cpu_dev->addr_abs + cpu_dev->x) & 0xFF00)) {
        CPU_READY_OR_STALL(cpu_dev, sre_abs_x_wait3);
        (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->x); // Page cross
    }
    CPU_READY_OR_STALL(cpu_dev, sre_abs_x_wait4);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->x);
    cpu_dev->temp = cpu_data;
...
void sre_zero_page_x_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, sre_zp_x_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, sre_zp_x_wait2);
    (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs); // Dummy read
    cpu_dev->addr_abs = (cpu_dev->addr_abs + cpu_dev->x) & 0xFF;
    CPU_READY_OR_STALL(cpu_dev, sre_zp_x_wait3);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->temp = cpu_data;
...
void rra_zero_page_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, rra_zp_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, rra_zp_wait2);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->temp = cpu_data;
...
void rra_indirect_x_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, rra_ind_x_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, rra_ind_x_wait2);
    (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs); // Dummy read
    cpu_dev->addr_abs = (cpu_dev->addr_abs + cpu_dev->x) & 0xFF;
    CPU_READY_OR_STALL(cpu_dev, rra_ind_x_wait3);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->lo = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, rra_ind_x_wait4);
    cpu_data = cpu_read_cycle(cpu_dev, (cpu_dev->addr_abs + 1) & 0xFF);
    cpu_dev->hi = cpu_data;
    cpu_dev->addr_abs = (cpu_dev->hi << 8) | cpu_dev->lo;
    CPU_READY_OR_STALL(cpu_dev, rra_ind_x_wait5);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->temp = cpu_data;
...
void rra_indirect_y_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, rra_ind_y_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, rra_ind_y_wait2);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->lo = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, rra_ind_y_wait3);
    cpu_data = cpu_read_cycle(cpu_dev, (cpu_dev->addr_abs + 1) & 0xFF);
    cpu_dev->hi = cpu_data;
    cpu_dev->addr_abs = (cpu_dev->hi << 8) | cpu_dev->lo;
    if ((cpu_dev->addr_abs & 0xFF00) != ((cpu_dev->addr_abs + cpu_dev->y) & 0xFF00)) {
        CPU_READY_OR_STALL(cpu_dev, rra_ind_y_wait4);
        (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->y); // Page cross
    }
    CPU_READY_OR_STALL(cpu_dev, rra_ind_y_wait5);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->y);
    cpu_dev->temp = cpu_data;
...
void rra_absolute_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, rra_abs_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, rra_abs_wait2);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs |= (cpu_data << 8);
    CPU_READY_OR_STALL(cpu_dev, rra_abs_wait3);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->temp = cpu_data;
...
void rra_absolute_y_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, rra_abs_y_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->lo = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, rra_abs_y_wait2);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->hi = cpu_data;
    cpu_dev->addr_abs = (cpu_dev->hi << 8) | cpu_dev->lo;
    if ((cpu_dev->addr_abs & 0xFF00) != ((cpu_dev->addr_abs + cpu_dev->y) & 0xFF00)) {
        CPU_READY_OR_STALL(cpu_dev, rra_abs_y_wait3);
        (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->y); // Page cross
    }
    CPU_READY_OR_STALL(cpu_dev, rra_abs_y_wait4);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->y);
    cpu_dev->temp = cpu_data;
...
void rra_absolute_x_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, rra_abs_x_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->lo = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, rra_abs_x_wait2);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->hi = cpu_data;
    cpu_dev->addr_abs = (cpu_dev->hi << 8) | cpu_dev->lo;
    if ((cpu_dev->addr_abs & 0xFF00) != ((cpu_dev->addr_abs + cpu_dev->x) & 0xFF00)) {
        CPU_READY_OR_STALL(cpu_dev, rra_abs_x_wait3);
        (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->x); // Page cross
    }
    CPU_READY_OR_STALL(cpu_dev, rra_abs_x_wait4);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->x);
    cpu_dev->temp = cpu_data;
...
void rra_zero_page_x_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, rra_zp_x_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, rra_zp_x_wait2);
    (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs); // Dummy read
    cpu_dev->addr_abs = (cpu_dev->addr_abs + cpu_dev->x) & 0xFF;
    CPU_READY_OR_STALL(cpu_dev, rra_zp_x_wait3);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->temp = cpu_data;
...
void sax_zero_page_y_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, sax_zp_y_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, sax_zp_y_wait2);
    (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs); // Dummy read
...
void sax_indirect_x_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, sax_ind_x_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, sax_ind_x_wait2);
    (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs); // Dummy read
    cpu_dev->addr_abs = (cpu_dev->addr_abs + cpu_dev->x) & 0xFF;
    CPU_READY_OR_STALL(cpu_dev, sax_ind_x_wait3);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->lo = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, sax_ind_x_wait4);
    cpu_data = cpu_read_cycle(cpu_dev, (cpu_dev->addr_abs + 1) & 0xFF);
    cpu_dev->hi = cpu_data;
    cpu_dev->addr_abs = (cpu_dev->hi << 8) | cpu_dev->lo;
...
void lax_zero_page_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, lax_zp_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, lax_zp_wait2);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->a = cpu_dev->x = cpu_data;
    cpu_set_zn(cpu_dev, cpu_dev->a);
    NEXT_INSTRUCTION(cpu_dev, lax_zp_fetch_wait);
}

void lax_zero_page_y_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, lax_zp_y_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, lax_zp_y_wait2);
    (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs); // Dummy read
    cpu_dev->addr_abs = (cpu_dev->addr_abs + cpu_dev->y) & 0xFF;
    CPU_READY_OR_STALL(cpu_dev, lax_zp_y_wait3);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->a = cpu_dev->x = cpu_data;
    cpu_set_zn(cpu_dev, cpu_dev->a);
...
void lax_absolute_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, lax_abs_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, lax_abs_wait2);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs |= (cpu_data << 8);
    CPU_READY_OR_STALL(cpu_dev, lax_abs_wait3);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->a = cpu_dev->x = cpu_data;
    cpu_set_zn(cpu_dev, cpu_dev->a);
...
void lax_absolute_y_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, lax_abs_y_wait1);
    cpu_dev->lo = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    CPU_READY_OR_STALL(cpu_dev, lax_abs_y_wait2);
    cpu_dev->hi = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = (cpu_dev->hi << 8) | cpu_dev->lo;
    
    if ((cpu_dev->addr_abs & 0xFF00) != ((cpu_dev->addr_abs + cpu_dev->y) & 0xFF00)) {
        // Page crossed - extra cycle
        CPU_READY_OR_STALL(cpu_dev, lax_abs_y_wait3);
        (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->y);
    }
    CPU_READY_OR_STALL(cpu_dev, lax_abs_y_wait4);
    uint8_tcpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->y);
    cpu_dev->a = cpu_dev->x = cpu_data;
    cpu_set_zn(cpu_dev, cpu_dev->a);
...
void lax_indirect_x_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, lax_ind_x_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, lax_ind_x_wait2);
    (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs); // Dummy read
    cpu_dev->addr_abs = (cpu_dev->addr_abs + cpu_dev->x) & 0xFF;
    CPU_READY_OR_STALL(cpu_dev, lax_ind_x_wait3);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->lo = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, lax_ind_x_wait4);
    cpu_data = cpu_read_cycle(cpu_dev, (cpu_dev->addr_abs + 1) & 0xFF);
    cpu_dev->hi = cpu_data;
    cpu_dev->addr_abs = (cpu_dev->hi << 8) | cpu_dev->lo;
    CPU_READY_OR_STALL(cpu_dev, lax_ind_x_wait5);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->a = cpu_dev->x = cpu_data;
    cpu_set_zn(cpu_dev, cpu_dev->a);
...
void lax_absolute_x_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, lax_abs_x_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->lo = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, lax_abs_x_wait2);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->hi = cpu_data;
    cpu_dev->addr_abs = ((cpu_dev->hi << 8) | cpu_dev->lo) + cpu_dev->x;
    CPU_READY_OR_STALL(cpu_dev, lax_abs_x_wait3);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->a = cpu_dev->x = cpu_data;
    cpu_set_zn(cpu_dev, cpu_dev->a);
...
void lax_zero_page_x_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, lax_zp_x_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = (cpu_data + cpu_dev->x) & 0xFF;
    CPU_READY_OR_STALL(cpu_dev, lax_zp_x_wait2);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->a = cpu_dev->x = cpu_data;
    cpu_set_zn(cpu_dev, cpu_dev->a);
...
void lax_indirect_y_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, lax_ind_y_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, lax_ind_y_wait2);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->lo = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, lax_ind_y_wait3);
    cpu_data = cpu_read_cycle(cpu_dev, (cpu_dev->addr_abs + 1) & 0xFF);
    cpu_dev->hi = cpu_data;
    cpu_dev->addr_abs = (cpu_dev->hi << 8) | cpu_dev->lo;
    ...
    if ((cpu_dev->addr_abs & 0xFF00) != ((cpu_dev->addr_abs + cpu_dev->y) & 0xFF00)) {
        // Page crossed - extra cycle
        CPU_READY_OR_STALL(cpu_dev, lax_ind_y_wait4);
        (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->y);
    }
    
    CPU_READY_OR_STALL(cpu_dev, lax_ind_y_wait5);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->y);
    cpu_dev->a = cpu_dev->x = cpu_data;
    cpu_set_zn(cpu_dev, cpu_dev->a);
...
void lax_immediate_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, lax_imm_wait);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->a = cpu_dev->x = cpu_data;
    cpu_set_zn(cpu_dev, cpu_dev->a);
...
void dcp_zero_page_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, dcp_zp_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, dcp_zp_wait2);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->temp = cpu_data;
...
void dcp_indirect_x_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, dcp_ind_x_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, dcp_ind_x_wait2);
    (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs); // Dummy read
    cpu_dev->addr_abs = (cpu_dev->addr_abs + cpu_dev->x) & 0xFF;
    CPU_READY_OR_STALL(cpu_dev, dcp_ind_x_wait3);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->lo = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, dcp_ind_x_wait4);
    cpu_data = cpu_read_cycle(cpu_dev, (cpu_dev->addr_abs + 1) & 0xFF);
    cpu_dev->hi = cpu_data;
    cpu_dev->addr_abs = (cpu_dev->hi << 8) | cpu_dev->lo;
    CPU_READY_OR_STALL(cpu_dev, dcp_ind_x_wait5);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->temp = cpu_data;
...
void dcp_indirect_y_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, dcp_ind_y_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, dcp_ind_y_wait2);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->lo = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, dcp_ind_y_wait3);
    cpu_data = cpu_read_cycle(cpu_dev, (cpu_dev->addr_abs + 1) & 0xFF);
    cpu_dev->hi = cpu_data;
    cpu_dev->addr_abs = (cpu_dev->hi << 8) | cpu_dev->lo;
    if ((cpu_dev->addr_abs & 0xFF00) != ((cpu_dev->addr_abs + cpu_dev->y) & 0xFF00)) {
        CPU_READY_OR_STALL(cpu_dev, dcp_ind_y_wait4);
        (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->y); // Page cross
    }
    CPU_READY_OR_STALL(cpu_dev, dcp_ind_y_wait5);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->y);
    cpu_dev->temp = cpu_data;
...
void dcp_absolute_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, dcp_abs_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, dcp_abs_wait2);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs |= (cpu_data << 8);
    CPU_READY_OR_STALL(cpu_dev, dcp_abs_wait3);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->temp = cpu_data;
...
void dcp_absolute_y_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, dcp_abs_y_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->lo = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, dcp_abs_y_wait2);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->hi = cpu_data;
    cpu_dev->addr_abs = (cpu_dev->hi << 8) | cpu_dev->lo;
    if ((cpu_dev->addr_abs & 0xFF00) != ((cpu_dev->addr_abs + cpu_dev->y) & 0xFF00)) {
        CPU_READY_OR_STALL(cpu_dev, dcp_abs_y_wait3);
        (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->y); // Page cross
    }
    CPU_READY_OR_STALL(cpu_dev, dcp_abs_y_wait4);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->y);
    cpu_dev->temp = cpu_data;
...
void dcp_absolute_x_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, dcp_abs_x_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->lo = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, dcp_abs_x_wait2);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->hi = cpu_data;
    cpu_dev->addr_abs = (cpu_dev->hi << 8) | cpu_dev->lo;
    if ((cpu_dev->addr_abs & 0xFF00) != ((cpu_dev->addr_abs + cpu_dev->x) & 0xFF00)) {
        CPU_READY_OR_STALL(cpu_dev, dcp_abs_x_wait3);
        (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->x); // Page cross
    }
    CPU_READY_OR_STALL(cpu_dev, dcp_abs_x_wait4);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->x);
    cpu_dev->temp = cpu_data;
...
void dcp_zero_page_x_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, dcp_zp_x_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, dcp_zp_x_wait2);
    (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs); // Dummy read
    cpu_dev->addr_abs = (cpu_dev->addr_abs + cpu_dev->x) & 0xFF;
    CPU_READY_OR_STALL(cpu_dev, dcp_zp_x_wait3);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->temp = cpu_data;
...
void isc_zero_page_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, isc_zp_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, isc_zp_wait2);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->temp = cpu_data;
...
void isc_indirect_x_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, isc_ind_x_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, isc_ind_x_wait2);
    (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs); // Dummy read
    cpu_dev->addr_abs = (cpu_dev->addr_abs + cpu_dev->x) & 0xFF;
    CPU_READY_OR_STALL(cpu_dev, isc_ind_x_wait3);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->lo = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, isc_ind_x_wait4);
    cpu_data = cpu_read_cycle(cpu_dev, (cpu_dev->addr_abs + 1) & 0xFF);
    cpu_dev->hi = cpu_data;
    cpu_dev->addr_abs = (cpu_dev->hi << 8) | cpu_dev->lo;
    CPU_READY_OR_STALL(cpu_dev, isc_ind_x_wait5);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->temp = cpu_data;
...
void isc_indirect_y_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, isc_ind_y_wait1);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, isc_ind_y_wait2);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->lo = cpu_data;
    CPU_READY_OR_STALL(cpu_dev, isc_ind_y_wait3);
    cpu_data = cpu_read_cycle(cpu_dev, (cpu_dev->addr_abs + 1) & 0xFF);
    cpu_dev->hi = cpu_data;
    cpu_dev->addr_abs = (cpu_dev->hi << 8) | cpu_dev->lo;
    if ((cpu_dev->addr_abs & 0xFF00) != ((cpu_dev->addr_abs + cpu_dev->y) & 0xFF00)) {
        CPU_READY_OR_STALL(cpu_dev, isc_ind_y_wait4);
        (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->y); // Page cross
    }
    CPU_READY_OR_STALL(cpu_dev, isc_ind_y_wait5);
    cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->y);
    cpu_dev->temp = cpu_data;
...
void isc_absolute_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, isc_abs_wait1);
    cpu_dev->addr_abs = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    CPU_READY_OR_STALL(cpu_dev, isc_abs_wait2);
    cpu_dev->addr_abs = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    CPU_READY_OR_STALL(cpu_dev, isc_abs_wait3);
    cpu_dev->temp = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
...
void isc_absolute_y_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, isc_abs_y_wait1);
    cpu_dev->lo = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    CPU_READY_OR_STALL(cpu_dev, isc_abs_y_wait2);
    cpu_dev->hi = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = (cpu_dev->hi << 8) | cpu_dev->lo;
    if ((cpu_dev->addr_abs & 0xFF00) != ((cpu_dev->addr_abs + cpu_dev->y) & 0xFF00)) {
        CPU_READY_OR_STALL(cpu_dev, isc_abs_y_wait3);
        (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->y); // Page cross
    }
    CPU_READY_OR_STALL(cpu_dev, isc_abs_y_wait4);
    cpu_dev->temp = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->y);
...
void isc_absolute_x_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, isc_abs_x_wait1);
    cpu_dev->lo = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    CPU_READY_OR_STALL(cpu_dev, isc_abs_x_wait2);
    cpu_dev->hi = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = (cpu_dev->hi << 8) | cpu_dev->lo;
    if ((cpu_dev->addr_abs & 0xFF00) != ((cpu_dev->addr_abs + cpu_dev->x) & 0xFF00)) {
        CPU_READY_OR_STALL(cpu_dev, isc_abs_x_wait3);
        (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->x); // Page cross
    }
    CPU_READY_OR_STALL(cpu_dev, isc_abs_x_wait4);
    cpu_dev->temp = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs + cpu_dev->x);
...
void isc_zero_page_x_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, isc_zp_x_wait1);
    cpu_dev->addr_abs = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    CPU_READY_OR_STALL(cpu_dev, isc_zp_x_wait2);
    (void)cpu_read_cycle(cpu_dev, cpu_dev->addr_abs); // Dummy read
    cpu_dev->addr_abs = (cpu_dev->addr_abs + cpu_dev->x) & 0xFF;
    CPU_READY_OR_STALL(cpu_dev, isc_zp_x_wait3);
    cpu_dev->temp = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
...
void anc_immediate_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, anc_imm_wait);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->a &= cpu_data;
    cpu_set_zn(cpu_dev, cpu_dev->a);
...
void alr_immediate_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, alr_imm_wait);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->a &= cpu_data;
...
void arr_immediate_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, arr_imm_wait);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->a &= cpu_data;
...
void xaa_immediate_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, xaa_imm_wait);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->a = (cpu_dev->a | 0xEE) & cpu_dev->x & cpu_data; // Unstable, but this is a common guess
    cpu_set_zn(cpu_dev, cpu_dev->a);
    NEXT_INSTRUCTION(cpu_dev, xaa_imm_fetch_wait);
}

void axs_immediate_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, axs_imm_wait);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    uint8_t val = cpu_dev->a & cpu_dev->x;
    uint16_t result = val - cpu_data;
...
void ahx_indirect_y_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, ahx_ind_y_wait1);
    cpu_dev->addr_abs = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    CPU_READY_OR_STALL(cpu_dev, ahx_ind_y_wait2);
    cpu_dev->lo = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    CPU_READY_OR_STALL(cpu_dev, ahx_ind_y_wait3);
    cpu_dev->hi = cpu_read_cycle(cpu_dev, (cpu_dev->addr_abs + 1) & 0xFF);
...
void tas_absolute_y_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, tas_abs_y_wait1);
    cpu_dev->lo = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    CPU_READY_OR_STALL(cpu_dev, tas_abs_y_wait2);
    cpu_dev->hi = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = ((cpu_dev->hi << 8) | cpu_dev->lo) + cpu_dev->y;
...
void shy_absolute_x_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, shy_abs_x_wait1);
    cpu_dev->lo = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    CPU_READY_OR_STALL(cpu_dev, shy_abs_x_wait2);
    cpu_dev->hi = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = ((cpu_dev->hi << 8) | cpu_dev->lo) + cpu_dev->x;
...
void shx_absolute_y_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, shx_abs_y_wait1);
    cpu_dev->lo = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    CPU_READY_OR_STALL(cpu_dev, shx_abs_y_wait2);
    cpu_dev->hi = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = ((cpu_dev->hi << 8) | cpu_dev->lo) + cpu_dev->y;
...
void ahx_absolute_y_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, ahx_abs_y_wait1);
    cpu_dev->lo = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    CPU_READY_OR_STALL(cpu_dev, ahx_abs_y_wait2);
    cpu_dev->hi = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = ((cpu_dev->hi << 8) | cpu_dev->lo) + cpu_dev->y;
    uint8_t val = cpu_dev->a & cpu_dev->x & ((cpu_dev->addr_abs >> 8) + 1);
...
void las_absolute_y_func(cpu6510_state_t* cpu_dev) {
    CPU_READY_OR_STALL(cpu_dev, las_abs_y_wait1);
    cpu_dev->lo = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    CPU_READY_OR_STALL(cpu_dev, las_abs_y_wait2);
    cpu_dev->hi = cpu_read_cycle(cpu_dev, cpu_dev->pc++);
    cpu_dev->addr_abs = ((cpu_dev->hi << 8) | cpu_dev->lo) + cpu_dev->y;
    CPU_READY_OR_STALL(cpu_dev, las_abs_y_wait3);
    uint8_t cpu_data = cpu_read_cycle(cpu_dev, cpu_dev->addr_abs);
    cpu_dev->a = cpu_dev->x = cpu_dev->sp = cpu_data & cpu_dev->sp;
    cpu_set_zn(cpu_dev, cpu_dev->a);
