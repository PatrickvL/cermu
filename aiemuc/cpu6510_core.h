#ifndef CPU6510_CORE_H
#define CPU6510_CORE_H
...
// ============================================================================
// MOS 6510 CPU CORE - Main header with state and function declarations
// ============================================================================
...
typedef struct {
    ...
    uint8_t temp;       // Temporary storage for addressing modes
    uint8_t lo, hi;     // Low/high bytes for multi-cycle operations
