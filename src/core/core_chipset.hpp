#pragma once
// =============================================================================
// core_chipset.hpp — Value-typed chip composition for Board<Spec, Chipset>
// =============================================================================
//
// CoreChipset<CPU, VIDEO, SOUND, IO> provides the four chip roles that
...
//
// Chipset contract:
//   - Must inherit CoreChipset<CPU, VIDEO, SOUND, IO>  (or at least
//     provide the type aliases: cpu_type, video_type, sound_type, io_type).
//   - May define bind_extras(Board& board) for extra chip members.
//
// Example:
//
//   struct MSX1Chips : CoreChipset<ZilogZ80A, TMS9918A, AY_3_8910, i8255_t> {
...
// ── CoreChipset — generic base for the common CPU + VIDEO + SOUND + IO roles
