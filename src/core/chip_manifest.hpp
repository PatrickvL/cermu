...
//       binds all slots, auto-calls MemoryChip::bind(), and wires the bus.
...
public:
    ...
    // (for MemoryChip::bind(), etc.), or nullptr for MMIO-only slots.
    //
...
//
//  // Single call: bind all chips, auto-call MemoryChip::bind(), wire bus
