...
#include "devices/display/crt_types.hpp"
#include "devices/display/lcd_types.hpp"
#include <cstdint>
...
///
/// CRT-specific sub-structs (phosphor, beam, mask, etc.) are defined in
/// crt_types.hpp; LCD-specific parameters in lcd_types.hpp.
struct DisplayCharacteristics {
    ...
    // --- CRT-specific (see crt_types.hpp) ---
    ...
    // --- LCD-specific (see lcd_types.hpp) ---
    LCDParams       lcd;
};
