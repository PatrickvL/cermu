...
// Uniforms:      Same set as signal_shader (ProjMtx, ScanlineMap, etc.)
//
...
namespace svideo_signal_shader {
...
// Create the S-Video signal shader program.
// Uses the same vertex shader and uniform layout as signal_shader.
