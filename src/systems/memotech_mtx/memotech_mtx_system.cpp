...
bool MemotechMTXSystem<V>::initialize() {
    ...
    board_.bind_chip(board_.template find_index<z80_ctc_t>(), &ctc_);
    ...
    psg_.set_clock_frequency(mtx_constants::CPU_FREQ_HZ / 16);
    ...
    // Display
    display_.init(mtx_constants::DISPLAY_WIDTH, mtx_constants::DISPLAY_HEIGHT);
