...
#define SVI318_FOR_EACH_SYSTEM_CHIP(X, ctx)                                                                               \
    ...
    X(ctx, TMS9918A,   vdp,  0x0080,      0, 0, 0, "TMS9918A",    "TMS9918A",    nullptr)                                 \
    X(ctx, AY_3_8910,  psg,  0x0088,      0, 0, 0, "AY-3-8910",   "AY-3-8910",   nullptr)                                \
    X(ctx, i8255_t,    ppi,  0x0096,      0, 0, 0, "i8255 PPI",   "i8255 PPI",   nullptr)                                 \
