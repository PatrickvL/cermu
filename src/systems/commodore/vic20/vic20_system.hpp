...
inline constexpr auto kVIC20Manifest = make_manifest(
    ...
    Slot<RAMChip>{.base_addr = 0x0400, .size_bytes = 0x0C00, .label = "Expansion Block 0", .condition = VIC20_EXP_BLOCK0},
    Slot<RAMChip>{.base_addr = 0x1000, .size_bytes = 0x1000, .label = "Base RAM 1"},
    Slot<RAMChip>{.base_addr = 0x2000, .size_bytes = 0x2000, .label = "Expansion Block 1", .condition = VIC20_EXP_BLOCK2},
    Slot<RAMChip>{.base_addr = 0x4000, .size_bytes = 0x2000, .label = "Expansion Block 2", .condition = VIC20_EXP_BLOCK3},
    Slot<RAMChip>{.base_addr = 0x6000, .size_bytes = 0x2000, .label = "Expansion Block 3", .condition = VIC20_EXP_BLOCK5},
