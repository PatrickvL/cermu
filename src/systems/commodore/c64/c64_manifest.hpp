...
//
// Row arguments:
//   X(ctx, type, chip, base, size, mask, overlay, label, rom_files)
//
...
#define C64_FOR_EACH_SYSTEM_CHIP(X, ctx)                                                                         \
    X(ctx, MOS6510,      cpu,      0x0000,       0,      0, 0, "MOS 6510",   nullptr)                             \
    X(ctx, RAMChip,      ram,      0x0000, 0x10000,      0, 1, "RAM",         nullptr)                             \
    X(ctx, ROMChip,      roml,     0x8000,  0x2000,      0, 1, "ROML",        nullptr)                             \
    X(ctx, ROMChip,      basic,    0xA000,  0x2000,      0, 1, "BASIC ROM",                                        \
