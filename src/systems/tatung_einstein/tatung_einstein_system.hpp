...
#define EINSTEIN_FOR_EACH_SYSTEM_CHIP(X, ctx)                                                                         \
    ...
    X(ctx, TMS9929A,    vdp,  0x0000,       0, 0, 0, "TMS9929A",   "TMS9929A",   nullptr)                            \
    X(ctx, AY_3_8910,   psg,  0x0000,       0, 0, 0, "AY-3-8910",  "AY-3-8910",  nullptr)                            \
    X(ctx, z80_ctc_t,   ctc,  0x0000,       0, 0, 0, "Z80 CTC",    "Z80 CTC",    nullptr)                            \
    X(ctx, z80_pio_t,   pio,  0x0000,       0, 0, 0, "Z80 PIO",    "Z80 PIO",    nullptr)                            \
