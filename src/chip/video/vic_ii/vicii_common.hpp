...
#define VICII_DECL(REG, FLD, CMP) \
    ...
    REG(32, EC,     "Border color",         Color, 3:0)                       \
    REG(33, B0C,    "Background color 0",   Color, 3:0)                       \
    REG(34, B1C,    "Background color 1",   Color, 3:0)                       \
    REG(35, B2C,    "Background color 2",   Color, 3:0)                       \
    REG(36, B3C,    "Background color 3",   Color, 3:0)                       \
    REG(37, MM0,    "Sprite mcolor 0",      Color, 3:0)                       \
    REG(38, MM1,    "Sprite mcolor 1",      Color, 3:0)                       \
    REG(39, M0C,    "Sprite 0 color",       Color, 3:0)                       \
    REG(40, M1C,    "Sprite 1 color",       Color, 3:0)                       \
    REG(41, M2C,    "Sprite 2 color",       Color, 3:0)                       \
    REG(42, M3C,    "Sprite 3 color",       Color, 3:0)                       \
    REG(43, M4C,    "Sprite 4 color",       Color, 3:0)                       \
    REG(44, M5C,    "Sprite 5 color",       Color, 3:0)                       \
    REG(45, M6C,    "Sprite 6 color",       Color, 3:0)                       \
    REG(46, M7C,    "Sprite 7 color",       Color, 3:0)                       \
...
// VicIITraits struct definition — see vicii_traits.hpp
#include "chip/video/vic_ii/vicii_traits.hpp"

// Trait instances live in per-variant headers:
