...
uint8_t wdc65c816_get_a(wdc65c816_t *cpu) { return CPU_CAST(cpu)->get(REG_A); }

uint8_t wdc65c816_get_x(wdc65c816_t *cpu) { return CPU_CAST(cpu)->get(REG_X); }

uint8_t wdc65c816_get_y(wdc65c816_t *cpu) { return CPU_CAST(cpu)->get(REG_Y); }

uint8_t wdc65c816_get_s(wdc65c816_t *cpu) {
  return CPU_CAST(cpu)->get(REG_SPL);
}

uint8_t wdc65c816_get_p(wdc65c816_t *cpu) { return CPU_CAST(cpu)->get(REG_P); }
