...
MC6809_CMP16_DIRECT(cmpd, regs_[REG_D])
MC6809_CMP16_INDEXED(cmpd, regs_[REG_D])
MC6809_CMP16_EXTENDED(cmpd, regs_[REG_D])

MC6809_CMP16_DIRECT(cmpy, regs_[REG_Y])
MC6809_CMP16_INDEXED(cmpy, regs_[REG_Y])
MC6809_CMP16_EXTENDED(cmpy, regs_[REG_Y])
...
MC6809_OP_LD16_DIRECT(ldy, regs_[REG_Y])
MC6809_OP_LD16_INDEXED(ldy, regs_[REG_Y])
MC6809_OP_LD16_EXTENDED(ldy, regs_[REG_Y])
...
bus_state_t op_lds_imm(bus_state_t pins) {
    ...
    case 1:
        ...
        return bus_setup_read(pins, regs_[REG_PC]);
    case 2:
        regs_[REG_S] = (static_cast<uint16_t>(data_hi_) << 8) | bus_read_data(pins);
        regs_[REG_PC]++;
        alu_ld16_flags(regs_[REG_S]);
        nmi_armed_ = true;
        transition_to_fetch();
        return pins;
    default: transition_to_fetch(); return pins;
...
MC6809_OP_ST16_DIRECT(sty, regs_[REG_Y])
MC6809_OP_ST16_INDEXED(sty, regs_[REG_Y])
MC6809_OP_ST16_EXTENDED(sty, regs_[REG_Y])

MC6809_OP_ST16_DIRECT(sts, regs_[REG_S])
MC6809_OP_ST16_INDEXED(sts, regs_[REG_S])
MC6809_OP_ST16_EXTENDED(sts, regs_[REG_S])
