...
// ============================================================================
//
// All internal registers live in a RegisterFile<20, uint16_t> whose byte
...
public:
    ...
    // === Chip identity ===
    mc6809_t() : CpuChipBase(ChipInfo{Traits.chip_id, Traits.vendor, Traits.display_name}) {
...
private:
    ...
    // REGISTER FILE
    // ========================================================================
    RegisterFile<20, uint16_t> regs_;
